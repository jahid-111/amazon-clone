...
const NotFound = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center min-h-screen bg-transparent px-4">
      {/* Twitter Logo */}
      <FaAmazon className=" text-primary text-6xl mb-6" />
      ...
      <Link
        to="/"
        className="bg-blue-500 hover:bg-blue-600 text-primary border hover:bg-gray-100 py-2 px-6 rounded-full text-lg font-semibold transition"
      >
        Go to Home
      </Link>
    </div>
